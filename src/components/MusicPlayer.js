...
const MusicPlayer = ({
  ...
  // Отслеживание горизонтального режима
  useEffect(() => {
    ...
    window.addEventListener('storage', checkHorizontalMode);
    
    return () => {
      window.removeEventListener('storage', checkHorizontalMode);
    };
  }, []);
        ...
        >
          {isHorizontalMode ? (
            <div className="volume-slider-horizontal">
              <div className="volume" style={{ width: `${volume}%` }}>
